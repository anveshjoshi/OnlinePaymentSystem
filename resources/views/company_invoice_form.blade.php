        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action=" {{ route('user.invoice_form') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="sender" type="text"
                                           ...
                                           name="sender" value="{{ Auth::user()->phone }}" required autocomplete="sender" autofocus readonly>
                            ...
                            <div class="form-group row">
                                <label for="payer_name"
                                       class="col-md-4 col-form-label text-md-right">{{ __('Full Name/Company Name') }}</label>
